...
<body class="bg-[#E5EFE8]">
    ...
    <div class="container mx-auto m-10 max-w-md">
        ...
        <div class="mx-auto p-4 bg-white rounded-3xl max-w-md"> <!-- Added max-w-md -->
            <form action="{{ route('personnel_save') }}" method="POST" enctype="multipart/form-data">
            ...
            @endif
                <div class="mb-4">
                    <label for="personnelName" class="block text-gray-700 font-bold mb-2 ">Support Personnel Name</label>
                    <input type="text" class="form-input w-full border border-solid border-gray-300" id="personnelName" name="personnelName" required>
                </div>

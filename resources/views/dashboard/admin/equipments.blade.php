            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Equipment Name</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($equipments as $equipments)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center">{{ $equipments->equipmentID }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">{{ $equipments->equipmentName }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <form method="POST" action="{{ route('equipments.destroy', $equipments->equipmentID) }}" class="inline-block justify-center">
                                    @csrf
                                    @method('DELETE')

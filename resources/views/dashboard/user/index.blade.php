        ...
        <div class="flex flex-col justify-between h-full">
            <div class="flex-grow">
                ...
                <div class="p-4">
                    <ul class="space-y-1">
                        <li>
                        <a href="/lla-dashboard" class="flex items-center bg-green-600 rounded-xl font-bold text-sm text-white py-2 px-4">
                            <span class="icon">
                        ...
                        <li>
                            <div class="relative">
                                ...
                                <div id="settingsDropdown" class="absolute hidden bg-white shadow-lg py-2 mt-2 w-100 rounded-xl">
                                    ...
                                    <a href="lla-profile" class=" hover:bg-green-300 flex font-bold text-sm text-gray-900 py-2 px-4">
                                        <span class="icon">

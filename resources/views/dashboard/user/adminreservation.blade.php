        ...
        <div class="flex flex-col justify-between h-full">
            <div class="flex-grow">
                ...
                <div class="p-4">
                    <ul class="space-y-1">
                        <li>
                        <a href="/lla-dashboard" class="flex  hover:bg-green-300  rounded-xl font-bold text-sm text-gray-900 py-2 px-4">
                        ...
                        <li>
                            <a href="/lla-reservation" class="flex items-center bg-green-600 rounded-xl font-bold text-sm text-white py-2 px-4">
                                <span class="icon">
                        ...
                        <li>
                            <a href="lla-facilities" class="flex  hover:bg-green-300  rounded-xl font-bold text-sm text-gray-900 py-2 px-4">
                                <span class="icon">
